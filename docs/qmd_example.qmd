...
as well as Quarto [@Allaire-Quarto-2022]. 
...
Additionally, note that in @tbl-horses we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops-plot.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horses-largest width=60%}

In @fig-horses-largest we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
